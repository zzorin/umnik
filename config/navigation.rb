...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :main_menu_item, 'Главная', root_path,
      html: { class: 'nav-item' },
      link_html: { class: 'nav-link' }

    primary.item :manage_menu_item, 'Управление', manage_root_path,
      html: { class: 'nav-item' },
      link_html: { class: 'nav-link', data: { turbolinks: false } } if can?(:manage, :spa)
    ...
    primary.dom_attributes = { class: 'nav nav-pills' }
